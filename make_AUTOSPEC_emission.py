...
def make_AUTOSPEC_emission(layersfile,chemfile,mollist):
    ...
    f = open(layersfile+'_AUTOSPEC_emission','w')
    ...
    # First row
    f.write('CONT   0  ')
    # For an emission spectrum, the last value should be 1.00E-05
    cont[-1] = '1.00E-05'
